...
-------- TRIGGER PARA TRATAR A ENTRADA DAS DATAS DE ENTRADA E SAÍDA DO ALUNO---------
-------- ASSIM, AO CONSTATAR QUE AS DATAS NÃO SÃO LÓGICASE UMA MENSAGEM DE ERRO É ENVIADA----
DELIMITER ??
...
------- TRIGGER PARA TRATAR O SALÁRIO DO PROFESSOR------
------- A PARTIR DA ENTRADA DAS HORAS DE TRABALHO, ENTÃO, É FEITA UMA MULTIPLICAÇÃO DAS HORAS PARA FAZER O RESULTADO EM SALÁRIO.-----
