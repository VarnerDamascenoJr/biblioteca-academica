...
#Select*from vw_listar01;       
#-----------------------------------------------------
#nao está funcionando.LISTAR AUTORES POR LIVROS
CREATE VIEW vw_listar02 AS 
SELECT autor.nome AS Autor,
       livro.titulo AS Título
FROM livro INNER JOIN autor ON autor.idautor = livro_has_autor.autor_idautor
		OR    livro_has_autor.livro_ISBN = livro.ISBN  ;  
#------------------------------------------------------

#Listar livros por editora ou categoria
